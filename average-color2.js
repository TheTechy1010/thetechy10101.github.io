function addImage1() {
  var img = document.getElementById('image4').src = "https://www.gstatic.com/webp/gallery/1.jpg";
  addImage("Color_5.png")
  //addImage("https://www.gstatic.com/webp/gallery/1.jpg");
  //var reader = new FileReader();
  //var file = reader.readAsDataURL(img);
...
function addImage(imagesrc) {
  ...
  element.innerHTML =
    ...
    '  <div class="box"></div>' +
    '  <ul>' +
    '<li><p class="name"><span class="btext">rgb(</span><span class="red"></span><span class="green"></span><span class="blue"></span><span class="btext">)</span> </p></li>'+
    '    <li class="rgb"></li>' +
    '<hr>'+
    '    <li class="hex"></li>' +
    '    <li class="hsl"></li>' +
  ...
  img.onload = function() {
    ...
    element.querySelector('.hex').textContent = 'HEX Color - ' + hexStr;
...
function GetNitroLevel(hexcode) {
  ...
  if (dec >= hexToDec("657321")) {
    str = "Nitrogen Deficient(Very Less Conc.)" +"Less than SWAP_1";
  }
